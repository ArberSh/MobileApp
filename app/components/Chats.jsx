...
const Chats = () => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        <Account name="Aleks" text="Hey I need your help" notification='2' image={"https://i.pinimg.com/originals/dc/4f/40/dc4f402448b8b309879645aefa1dde46.jpg"}/>
        <Account name="Mario" text="Actually i like it" image={"https://i.pinimg.com/236x/68/31/12/68311248ba2f6e0ba94ff6da62eac9f6.jpg"}/>
